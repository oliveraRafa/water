...
public class BoatPhysics : MonoBehaviour 
{
	...
	void Start() 
	{
		...
		//Subdividimos mesh para mejorar 
		//MeshHelper.Subdivide4(boatMeshObj.GetComponent<MeshFilter>().mesh);
	...
	void AddUnderWaterForces()
	{
		...
		for (int i = 0; i < underWaterTriangleData.Count; i++)
		{
			...
			//Debug.DrawRay(triangleData.center, viscousWaterResistanceForce.normalized * 3f, Color.black);
		}
	}
